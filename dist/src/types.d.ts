...
export { Logger, };
export type TypeNameIdentifierType = 'bool' | 'bytea' | 'float4' | 'float8' | 'int2' | 'int4' | 'int8' | 'json' | 'text' | 'timestamptz' | 'uuid';
export type SerializableValueType = boolean | number | string | readonly SerializableValueType[] | {
...
export type StreamFunctionType = (sql: TaggedTemplateLiteralInvocationType, streamHandler: StreamHandlerType, options?: any) => Promise<Record<string, unknown> | null>;
export type QueryCopyFromBinaryFunctionType = (streamQuery: TaggedTemplateLiteralInvocationType, tupleList: ReadonlyArray<readonly any[]>, columnTypes: readonly TypeNameIdentifierType[]) => Promise<Record<string, unknown> | null>;
...
export type PrimitiveValueExpressionType = boolean | number | string | readonly PrimitiveValueExpressionType[] | null;
export type SqlTokenType = ArraySqlTokenType | BinarySqlTokenType | IdentifierSqlTokenType | JsonSqlTokenType | ListSqlTokenType | SqlSqlTokenType | UnnestSqlTokenType;
...
export type InternalQueryMethodType<R> = (log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, sql: string, values: readonly PrimitiveValueExpressionType[], uid?: QueryIdType) => R;
export type InternalCopyFromBinaryFunctionType = (log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, sql: string, boundValues: readonly PrimitiveValueExpressionType[], tupleList: ReadonlyArray<readonly any[]>, columnTypes: readonly TypeNameIdentifierType[]) => Promise<Record<string, unknown>>;
export type InternalStreamFunctionType = (log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, sql: string, values: readonly PrimitiveValueExpressionType[], streamHandler: StreamHandlerType, uid?: QueryIdType) => Promise<Record<string, unknown>>;
export type InternalTransactionFunctionType = <T>(log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, handler: TransactionFunctionType<T>) => Promise<T>;
export type InternalNestedTransactionFunctionType = <T>(log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, handler: TransactionFunctionType<T>, transactionDepth: number) => Promise<T>;
...
export type QueryAnyFirstFunctionType = <T = QueryResultRowColumnType, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<ReadonlyArray<Row[keyof Row]>>;
export type QueryAnyFunctionType = <T = ExternalQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<readonly T[]>;
export type QueryExistsFunctionType = (sql: TaggedTemplateLiteralInvocationType, values?: PrimitiveValueExpressionType[]) => Promise<boolean>;
export type QueryFunctionType = <T = ExternalQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<QueryResultType<T>>;
export type QueryManyFirstFunctionType = <T = QueryResultRowColumnType, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<ReadonlyArray<Row[keyof Row]>>;
export type QueryManyFunctionType = <T = ExternalQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<readonly T[]>;
export type QueryMaybeOneFirstFunctionType = <T = QueryResultRowColumnType, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<Row[keyof Row] | null>;
export type QueryMaybeOneFunctionType = <T = ExternalQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<T | null>;
export type QueryOneFirstFunctionType = <T = QueryResultRowColumnType, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<Row[keyof Row]>;
export type QueryOneFunctionType = <T = ExternalQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<T>;
