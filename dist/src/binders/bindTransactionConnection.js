...
const bindTransactionConnection = (parentLog, connection, clientConfiguration, transactionDepth) => {
    ...
    return {
        ...
        stream: (query, streamHandler, opts) => {
            (0, assertions_1.assertSqlSqlToken)(query);
            assertTransactionDepth();
            return (0, connectionMethods_1.stream)(parentLog, connection, clientConfiguration, query.sql, query.values, streamHandler, opts);
        },
        transaction: (handler) => {
            assertTransactionDepth();
            return (0, connectionMethods_1.nestedTransaction)(parentLog, connection, clientConfiguration, handler, transactionDepth);
        },
    };
};
